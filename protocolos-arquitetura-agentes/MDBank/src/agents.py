...
#saída de forma estruturada, para evitar alucinaações com saídas estranhas
...
#classificador de perguntas: se a pergunta for relacionada a cartão de crédito, direciona para o agente_cartao_credito, se for relacionada a abertura de conta, direciona para o agente_abertura_conta
